                    ...
                    <div className="flex-1 space-y-3">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                        ...
                        <div>
                          ...
                          <PriceDisplay amount={log.item.seller_quoted_price} />
                        </div>
                        <div>
                          <p className="text-muted-foreground">Payout</p>
                          {log.item.final_payout > 0 ? (
                            <PriceDisplay amount={log.item.final_payout} />
                          ) : (
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm pt-2 border-t">
                          ...
                          <div>
                            ...
                            {log.item.repair_cost > 0 ? (
                              <PriceDisplay amount={log.item.repair_cost} />
                            ) : (
                              <p className="font-medium">-</p>
                            )}
                          </div>
                          <div>
                            ...
                            {log.item.selling_price > 0 ? (
                              <PriceDisplay amount={log.item.selling_price} />
                            ) : (
                              <p className="font-medium">-</p>
                            )}
                          </div>
